      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className={`p-4 rounded-xl border-2 transition-all ${user.theme === 'light'
          ...
          <button
            ...
            className={`p-4 rounded-xl border-2 transition-all ${user.theme === 'dark'
              ? 'border-violet-400 bg-violet-50 dark:bg-violet-900/20'
              : 'border-gray-200 dark:border-gray-700 hover:border-violet-200'
              }`}
          >
        ...
        <div className="grid grid-cols-3 gap-3">
          {DEFAULT_BACKGROUNDS.map((bg) => (
            <button
              ...
              className={`relative h-24 rounded-xl border-2 transition-all overflow-hidden ${user.backgroundId === bg.id
